...
LANG_MAP = {
    ...
    "Bahasa Melayu": {
        ...
        * **👑 PAKEJ GERGASI E-DAGANG**: **$49.99** (Dapat **2,000 Kredit** ── **Nilai Hebat: Di bawah RM0.11 bagi setiap gambar!**)
        ...
        "limit_err": "🔒 PAKEJ DIKUNCI ── Had pelan percuma telah melebihi (Maks 10 Credits/24H). Sila log masuk or beli pakej token di bawah untuk memuat turun fail ZIP resolusi tinggi dengan segera.",
        "usage_title": "📊 STATUS DOMPET PREMIUM SAAS",
        "guest_info": "🕒 Dompet Percubaan Tanpa Daftar:\n* Had Harian Digunakan: **{} / 10** Credits\n*(Set semula automatik setiap 24 jam)*",
...
# 👑 👑 👑 【全域安全路徑對齊防線】 👑 👑 👑
# 將 zip_path 抽離出所有迴圈與 start_btn 外部，宣告在第四部分最頂層的最左側（無縮排對齊）！
# 這樣即使網頁因為點擊下載而二度 Rerun 刷新，變數指針永不丟失！100% 杜絕 SyntaxError 錯誤！
